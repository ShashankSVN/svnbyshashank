 ...
 * 
 */
public class TreeSetBiscuitComparatorDemo {

	public static void main(String[] args) {

		//it will maintained the order
		Set<Biscuit> list = new TreeSet<Biscuit>(new TasteDescendingBidDescendingComparator());
		//it is based on binary search tree 
		//what ever object we are adding here that should be sortable
